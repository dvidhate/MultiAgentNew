...
import algo.QLearningRuleJR;
import algo.QLearningRuleLamda;
import algo.QLearningRuleSS;
import algo.Record;
...
public class QCSLJInternalFrame4 extends javax.swing.JInternalFrame {
     ...
     */
    public QCSLJInternalFrame4(int index, boolean flag) {
        initComponents();
        refreshCombo();
        this.index = index;
        if (!flag) {
        ...
        if (index == 0) {
            setTitle("Weighted Strategy Shairing  Algorithm (WSS - QL)" + (flag ? "With Experness" : ""));
            jButton3.setText("Weighted Strategy Shairing  Algorithm (WSS - QL)");
        } else if (index == 1) {
            setTitle("Weighted Strategy Shairing  Algorithm (WSS - Sarsa)" + (flag ? "With Experness" : ""));
            jButton3.setText("Weighted Strategy Shairing  Algorithm (WSS - Sarsa)");
        } else if (index == 2) {
            setTitle("Weighted Strategy Shairing  Algorithm (WSS - QL Lamda)" + (flag ? "With Experness" : ""));
            jButton3.setText("Weighted Strategy Shairing  Algorithm (WSS - QL Lamda)");
        } else if (index == 3) {
            setTitle("Weighted Strategy Shairing  Algorithm (WSS - Sarsa Lamda)" + (flag ? "With Experness" : ""));
            jButton3.setText("Weighted Strategy Shairing  Algorithm (WSS - Sarsa Lamda)");
        } else if (index == 4) {
            setTitle("Weighted Strategy Shairing  Algorithm (WSS - QL)");
            jButton3.setText("Weighted Strategy Shairing  Algorithm (WSS - QL)");

        }else if (index == 5) {
            setTitle("Joint Rewards Algorithm");
            jButton3.setText("Joint Rewards Algorithm");
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Abs", "Positive", "Negative", "Certarnity", "Entropy" }));
        ...
        new Thread() {
            ...
            public void run() {
                ...
                if (index == 0) {
                    ...
                    for (int i = 0; i < 4; i++) {
                        al.add(new QLearningRuleSS());
                    }
                } else if (index == 5) {
                    for (int i = 0; i < 4; i++) {
                        al.add(new QLearningRuleJR());
                    }
                }
                cs.cslearn(jComboBox1.getSelectedItem().toString(), jComboBox2.getSelectedItem().toString(), al, jComboBox3.getSelectedIndex());
