 ...
 * @author ganesh
 */
public class QLJInternalFrame extends javax.swing.JInternalFrame {

    /**
     * Creates new form RandomJInternalFrame
     */
    public QLJInternalFrame() {
        initComponents();
        refreshCombo();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reinforcement Q Learning");
        setToolTipText("");
...
//        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(QLJInternalFrame.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                fr.close();
            } catch (IOException ex) {
