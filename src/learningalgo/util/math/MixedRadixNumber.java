...
public class MixedRadixNumber extends Number {
     ...
     *
     * @throws IllegalArgumentException if any of the specified numerals is less
     * than zero, or if any of the specified numerals is greater than it's
     * corresponding radix.
     */
     ...
     * radices.
     *
     * @throws IllegalArgumentException if no radices are defined, if any radix
     * is less than two, or if the current value is greater than the maximum
     * value which can be represented by the current array of radices.
     */
