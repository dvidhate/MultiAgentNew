...
public class Interval<C> {
     ...
     *
     * @param lower the lower end point of the interval
     * @param lowerInclusive wether or not the lower end of the interval is
     * inclusive of its value.
     * @param upper the upper end point of the interval
     * @param upperInclusive whether or not the upper end of the interval is
     * inclusive of its value.
     */
