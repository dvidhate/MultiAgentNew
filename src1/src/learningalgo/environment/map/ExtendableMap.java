...
import learningalgo.util.datastructure.LabeledGraph;
import learningalgo.util.datastructure.Point2D;
...
public class ExtendableMap implements Map {
     ...
     * @param dir bearing (compass direction) in which the location is seen from
