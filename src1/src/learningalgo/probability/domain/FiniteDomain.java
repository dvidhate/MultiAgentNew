package learningalgo.probability.domain;
...
public interface FiniteDomain extends DiscreteDomain {
     ...
     * of possible values.
     * @exception IllegalArgumentException if the value is not valid for the
     * domain.
     */
     ...
     * ordered set of values. null if the offset does not index the domain
     * correctly.
     */
