package learningalgo.probability;
...
public interface CategoricalDistribution extends ProbabilityMass {
    ...
    public interface Iterator {
         ...
         *
         * @param possibleAssignment a possible assignment, &omega;, of
     ...
     *
     * @param values an ordered set of values for the random variables
     * comprising the Distribution (<b>Note:</b> the order must match the order
     ...
     * summed out and a new set of values updated with the summed out values.
     */
     ...
     * @throws IllegalArgumentException if the variables of the divisor
     * distribution are not a subset of the dividend.
     */
     ...
     * passed in multiplier. The order of the variables comprising the product
     * distribution is the ordered union of the left term (this) and the right
     * term (multiplier).
     *
     ...
     * (the General case of Baye's rule, AIMA3e pg. 496), using this API
     * method:<br>
     * <br>
     ...
     *
     * @param multiplier
     * @param prodVarOrder the order the variables comprising the product are to
     * be in.
     *
     * @return a new Distribution representing the product of this and the
     * passed in multiplier. The order of the variables comprising the product
     * distribution is the order specified.
     *
     ...
     *
     * @param cdi the CategoricalDistribution Iterator to iterate
     * @param fixedValues Fixed values for a subset of the Random Variables
     * comprising this CategoricalDistribution.
     */
