package learningalgo.probability.util;

import java.util.Map;

import learningalgo.probability.CategoricalDistribution;
import learningalgo.probability.RandomVariable;
import learningalgo.probability.bayes.Node;
import learningalgo.probability.domain.FiniteDomain;
import learningalgo.probability.proposition.ConjunctiveProposition;
import learningalgo.probability.proposition.Proposition;
import learningalgo.util.Randomizer;
import learningalgo.util.Util;
import learningalgo.util.math.MixedRadixNumber;
...
public class ProbUtil {
     ...
     * @param r a Randomizer for generating a probability choice for the sample.
     ...
     *
     * @param Xi a Node for the Random Variable Xi whose parent values are to be
     * extracted from the provided event in the correct order.
     ...
     *
     * @param Xi a Node for the Random Variable Xi whose parent values and value
     * are to be extracted from the provided event in the correct order.
