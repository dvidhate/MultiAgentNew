...
public interface Proposition {
     ...
     * not constrained to any particular set of values (e.g. bound = P(Total =
     * 11), while unbound = P(Total)). If a variable is unbound it implies the
     ...
     * world.
     *
     * @param possibleWorld A possible world is defined to be an assignment of
     * values to all of the random variables under consideration.
