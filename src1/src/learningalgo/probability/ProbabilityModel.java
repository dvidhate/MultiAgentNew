...
public interface ProbabilityModel {
     ...
     * &sum;<sub>&omega; &isin; &Omega;
     * </sub> P(&omega;) = 1 (Equation 13.1 pg. 484 AIMA3e), false otherwise.
     */
    boolean isValid();
     ...
     * variables describing the atomic variable/value pairs this probability
     * model can take on. Refer to pg. 486 AIMA3e.
     */
