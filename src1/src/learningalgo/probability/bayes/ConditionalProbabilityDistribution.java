...
import learningalgo.probability.ProbabilityDistribution;
...
public interface ConditionalProbabilityDistribution {
     ...
     * parentValues must equal getParents() and their domains must match.
     ...
     * set of cases for the random variable.
     *
     * @param parentValues for the conditioning case. The size of parentValues
     * must equal getParents() and their Random Variables must match.
     * @return the Probability Distribution for the Random Variable the
     * Conditional Probability Distribution is On.
     * @see ConditionalProbabilityDistribution#getOn()
     * @see ConditionalProbabilityDistribution#getParents()
     ...
     * distribution is on.
     *
     * @param probabilityChoice a double value, from the range [0.0d, 1.0d),
     * i.e. 0.0d (inclusive) to 1.0d (exclusive).
     * @param parentValues for the conditioning case. The ordering and size of
     * parentValues must equal getParents() and their domains must match.
