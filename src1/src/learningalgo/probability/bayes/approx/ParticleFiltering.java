...
import learningalgo.probability.FiniteProbabilityModel;
import learningalgo.probability.RandomVariable;
import learningalgo.probability.bayes.DynamicBayesianNetwork;
import learningalgo.probability.bayes.exact.EliminationAsk;
import learningalgo.probability.bayes.model.FiniteBayesModel;
import learningalgo.probability.domain.FiniteIntegerDomain;
import learningalgo.probability.proposition.AssignmentProposition;
import learningalgo.probability.util.ProbUtil;
import learningalgo.probability.util.RandVar;
import learningalgo.util.JavaRandomizer;
import learningalgo.util.Randomizer;
import learningalgo.util.Util;
...
public class ParticleFiltering {
     ...
     * model <b>P</b>(<b>X</b><sub>1</sub> | <b>X</b><sub>0</sub>), sensor model
     * <b>P</b>(<b>E</b><sub>1</sub> |
     * <b>X</b><sub>1</sub>)
     */
     ...
     * assignment propositions for the X_1 state variables, which is intended to
     * represent the generated sample for time t.
     */
     ...
     * @param S a vector of samples of size N, where each sample is a vector of
     * assignment propositions for the X_1 state variables, which is intended to
     * represent the sample for time t
