package learningalgo.probability.temporal.generic;
...
import learningalgo.probability.temporal.ForwardBackwardInference;
import learningalgo.probability.util.ProbUtil;
import learningalgo.probability.util.ProbabilityTable;
...
public class ForwardBackward implements ForwardBackwardInference {
     ...
     * @param tToTm1StateVarMap a map from the X<sub>t<sub> random variables in
     * the transition model the to X<sub>t-1</sub> random variables.
