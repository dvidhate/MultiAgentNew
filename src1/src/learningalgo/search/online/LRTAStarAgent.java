...
import learningalgo.agent.impl.AbstractAgent;
import learningalgo.agent.impl.NoOpAction;
import learningalgo.search.framework.HeuristicFunction;
import learningalgo.search.framework.PerceptToStateFunction;
import learningalgo.util.datastructure.TwoKeyHashMap;
...
public class LRTAStarAgent extends AbstractAgent {
     ...
     * @param ptsFunction a function which returns the problem state associated
     * with a given Percept.
     * @param hf heuristic function <em>h(n)</em>, which estimates the cost of
     * the cheapest path from the state at node <em>n</em> to a goal state.
     */
