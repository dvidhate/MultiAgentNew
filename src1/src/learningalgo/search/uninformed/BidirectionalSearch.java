...
import learningalgo.search.framework.GraphSearch;
...
import learningalgo.util.datastructure.FIFOQueue;
...
public class BidirectionalSearch implements Search {
     ...
     *
     * @param queueSize the number of items in the queue.
     */
     ...
     *
     * @param pathCost the cost of the path from the initial state to a goal
     * state.
     */
