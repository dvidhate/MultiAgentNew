...
public class Problem {
     ...
     * @param actionsFunction a description of the possible actions available to
     * the agent.
     * @param resultFunction a description of what each action does; the formal
     * name for this is the transition model, specified by a function RESULT(s,
     ...
     * a) that returns the state that results from doing action a in state s.
     * @param goalTest test determines whether a given state is a goal state.
     * @param stepCostFunction a path cost function that assigns a numeric cost
     * to each path. The problem-solving-agent chooses a cost function that
