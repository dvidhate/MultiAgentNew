package learningalgo.search.local;
...
import learningalgo.util.CancelableThread;
...
public class SimulatedAnnealingSearch extends NodeExpander implements Search {
     ...
     *
     * @param temperature
     * <em>T</em>, a "temperature" controlling the probability of downward steps
