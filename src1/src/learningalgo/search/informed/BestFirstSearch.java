...
import learningalgo.search.framework.PrioritySearch;
...
public class BestFirstSearch extends PrioritySearch {
     ...
     * @param ef an evaluation function, which returns a number purporting to
     * describe the desirability (or lack thereof) of expanding a node
     */
