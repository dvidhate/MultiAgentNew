...
public interface Environment {
     ...
     *
     * @param forAgent the Agent for which a performance measure is to be
     * retrieved.
     ...
     *
     * @param ev the EnvironmentView to be added.
     */
     ...
     *
     * @param ev the EnvironmentView to be removed.
     */
     ...
     *
     * @param msg the message to notify the registered EnvironmentViews with.
     */
