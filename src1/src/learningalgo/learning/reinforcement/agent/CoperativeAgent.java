package learningalgo.learning.reinforcement.agent;
...
/**
 * An abstract base class for creating CoperativeAgent based agents.
 *
 ...
 *
 */
public abstract class CoperativeAgent<S, A extends Action> extends AbstractAgent {

    /**
     * Default Constructor.
     */
    public CoperativeAgent() {
    }
