...
public class Table<RowHeaderType, ColumnHeaderType, ValueType> {
     ...
     * Neither the row nor the column nor the value can be <code>null</code>
     * <br>
     ...
     * @param v the value
     *
     * @throws NullPointerException if the row, column, or value is
     * <code>null</code>.
     */
     ...
     * <code>null</code> if the row and column is not mapped to any values in
     * this table.
     *
