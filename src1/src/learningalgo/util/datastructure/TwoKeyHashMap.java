package learningalgo.util.datastructure;
...
public class TwoKeyHashMap<K1, K2, V> extends HashMap<Pair<K1, K2>, V> {
     ...
     * is to be associated.
     * @param key2 the second key of the key pair, with which the specified
     ...
     * cases.
     *
     * @param key1 the first key of the key pair, whose associated value is to
     * be returned.
     ...
     * <code>null</code> if the map contains no mapping for this key pair.
     */
     ...
     * specified key pair.
     *
     * @param key1 the first key of the key pair whose presence in this map is
     * to be tested.
     ...
     * from the map.
     * @param key2 the second key of the key pair, whose mapping is to be
     ...
     * associated <code>null</code> with the specified key pair.
     */
